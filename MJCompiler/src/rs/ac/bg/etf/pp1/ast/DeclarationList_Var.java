...
public class DeclarationList_Var extends DeclarationList {

    private DeclarationList DeclarationList;
    private GlobalVarDecl GlobalVarDecl;

    public DeclarationList_Var (DeclarationList DeclarationList, GlobalVarDecl GlobalVarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DeclarationList_Var(\n");
