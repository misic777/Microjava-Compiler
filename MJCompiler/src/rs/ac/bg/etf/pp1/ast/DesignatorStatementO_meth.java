...
public class DesignatorStatementO_meth extends DesignatorStatementOther {

    private Designator Designator;
    private ActParsOptional ActParsOptional;

    public DesignatorStatementO_meth (Designator Designator, ActParsOptional ActParsOptional) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementO_meth(\n");
