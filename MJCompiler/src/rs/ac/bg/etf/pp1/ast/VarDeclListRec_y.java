...
public class VarDeclListRec_y extends VarDeclListRec {

    private VarDeclListRec VarDeclListRec;
    private VarDeclList VarDeclList;

    public VarDeclListRec_y (VarDeclListRec VarDeclListRec, VarDeclList VarDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VarDeclListRec_y(\n");
